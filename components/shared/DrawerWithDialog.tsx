    ...
    return (
      <>
        <Button
          ...
          className={`${
            shouldOpenForCreatePlan && "bg-[#6D5FFD]  hover:bg-blue-600 text-white flex gap-1"
          }`}
          onClick={() => {
            setOpen(true);
          }}
    ...
    <Drawer open={open} onOpenChange={setOpen}>
      <DrawerTrigger asChild>
        <Button
          ...
          className={`${
            shouldOpenForCreatePlan && "bg-[#6D5FFD] text-white hover:bg-blue-600 flex gap-1"
          }`}
        >
          {shouldOpenForCreatePlan && <Backpack className="h-4 w-4" />}
          <span>{btnText}</span>
    ...
    <div>
      ...
      <Link
        className={cn(
          ...
          "bg-[#6D5FFD] text-white hover:bg-[#6D5FFD9A]",
